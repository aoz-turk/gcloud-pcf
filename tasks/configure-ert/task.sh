...
cf_resources=$(
  jq -n \
    ...
    '
    {
      "backup-prepare": {"internet_connected": $internet_connected, "instance_type": {"id": "micro.cpu"}},
      ...
      "nfs_server": {"internet_connected": $internet_connected, "persistent_disk": {"size_mb": "51200"}, "instance_type": {"id": "medium"}},
